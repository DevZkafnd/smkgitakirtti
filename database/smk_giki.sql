...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2025 at 08:05 AM
...
(13, NULL, NULL, '4201010101010001', NULL, 'Putri Ayu', 'putri@example.com', '098f6bcd4621d373cade4e832627b4f6', '082345678901', 'Perempuan', NULL, NULL, NULL, NULL, NULL, 'Jl. Raya No. 88', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '-', NULL, NULL, NULL, NULL, NULL, 1),
(20, 1, 1, '3174090101010004', '230004', 'Raul', 'raul@gmail.com', '098f6bcd4621d373cade4e832627b4f6', '3619788090', 'Laki-Laki', '2025-07-12', 'DKI JAKARTA', 'KOTA JAKARTA TIMUR', 'KRAMAT JATI', 'KAMPUNG TENGAH', '4982  Franklin Avenue', 'Wiraswasta', 'Guru', '-', '3619788090', '', 2025, 'Yamal', 'Yuli', '', 'Rp. 4.000.000 - Rp. 5.000.000', '0bc80254-c0a5-43c6-a3e0-b280038d82c3_jpeg.jpg', 'Screenshot_2025-07-11_2120348.png', 'Screenshot_2025-07-11_2120349.png', 'Screenshot_2025-07-11_21203410.png', 2),
(21, NULL, NULL, '4201010101010002', NULL, 'Ujang Ramlan', 'ujang@gmail.com', '098f6bcd4621d373cade4e832627b4f6', '082345678902', 'Laki-Laki', NULL, NULL, NULL, NULL, NULL, '4982  Franklin Avenue', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
...
--
ALTER TABLE `tb_requesttransaksi`
  ADD CONSTRAINT `fk_jurusan_request` FOREIGN KEY (`id_jurusan`) REFERENCES `jurusan` (`id_jurusan`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_kelas_request` FOREIGN KEY (`id_kelas`) REFERENCES `kelas` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
